  ...
  return (
    <div className='container'>
      <main className='grid grid-cols-12 gap-7'>
        <div className={classNames({'col-span-3': isDesktop, 'col-span-4': isTablet, 'hidden': isMobile})}>
          <Friends />
          <PeopleYouMightKnow />
        </div>
        <Newsfeed wrapperClassName={classNames({'col-span-6': isDesktop, 'col-span-8': isTablet, '!col-span-12':isMobile})} />
